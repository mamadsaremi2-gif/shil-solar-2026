...
export default function RunCalculation() {
  ...
  const nativeSummaryRows = emergency ? [
    ...
    { label: "پشتیبانی هدف", value: `${formatNumber(runContext.backupHours, 2)} ساعت` },
    { label: "پشتیبانی واقعی", value: `${formatNumber(runContext.runtimeHours, 2)} ساعت` },
            ...
            <section className="shil-a4-section">
              ...
              <div className="shil-a4-fields shil-a4-fields-design">
                {emergency ? (<>
                  ...
                  <div><A4Label>پشتیبانی هدف</A4Label><b dir="ltr" style={{ ...A4_HARD_STYLE.answer, unicodeBidi: "isolate" }}>{`${formatNumber(runContext.backupHours, 2)} ساعت`}</b></div>
                  <div><A4Label>پشتیبانی واقعی</A4Label><b dir="ltr" style={{ ...A4_HARD_STYLE.answer, unicodeBidi: "isolate" }}>{`${formatNumber(runContext.runtimeHours, 2)} ساعت`}</b></div>
