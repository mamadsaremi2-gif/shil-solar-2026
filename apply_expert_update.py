...
root = Path('/mnt/data/shil_equipment_expert_update')

lib = root/'src/data/catalogs/consumerEquipmentLibrary.js'
text = lib.read_text()
text = text.replace('    diversityFactor,\n    startupFactor: base[3],\n    surgeFactor: base[3],\n    energyDailyWh,', '    diversityFactor,\n    simultaneityFactor: diversityFactor,\n    powerFactor: base[3] > 1.7 ? 0.82 : base[5] === "heavy" ? 0.88 : 0.95,\n    startupFactor: base[3],\n    surgeFactor: base[3],\n    motorStartCurrentFactor: base[3] > 1.7 ? 1.7 : 1,\n    softStarterFactor: base[3] > 1.7 ? 1.2 : 1,\n    hasSoftStarter: false,\n    energyDailyWh,')
lib.write_text(text)

engine = root/'src/core/calculation/loadEngine.js'
engine.write_text(r'''export const METHOD_LABELS = {
