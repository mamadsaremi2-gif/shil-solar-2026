...
export const projectSteps = [
  { key: "info", title: "Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ù¾Ø±ÙˆÚ˜Ù‡", to: "/new-project/info", image: SHIL_ASSETS.icons.project.info, icon: <FolderOpen size={40} /> },
  { key: "environment", title: "Ø´Ø±Ø§ÛŒØ· Ù…Ø­ÛŒØ·ÛŒ", to: "/new-project/environment", image: SHIL_ASSETS.icons.project.environment, icon: <MapPin size={40} /> },
  { key: "path", title: "Ø§Ù†ØªØ®Ø§Ø¨ Ù…Ø³ÛŒØ± Ù¾Ø±ÙˆÚ˜Ù‡", to: "/new-project/path", image: SHIL_ASSETS.icons.project.path, icon: <Route size={40} /> },
  { key: "method", title: "Ø±ÙˆØ´ Ù…Ø­Ø§Ø³Ø¨Ø§Øª", to: "/new-project/method", image: SHIL_ASSETS.icons.project.method, icon: <Calculator size={40} /> },
  { key: "inputs", title: "ÙˆØ±ÙˆØ¯ÛŒ Ù…Ø­Ø§Ø³Ø¨Ø§Øª", to: "/new-project/inputs", image: SHIL_ASSETS.icons.project.inputs, icon: <ClipboardList size={40} /> },
  { key: "system", title: "ØªÙ†Ø¸ÛŒÙ…Ø§Øª Ø³ÛŒØ³ØªÙ…", to: "/new-project/system", image: SHIL_ASSETS.icons.project.system, icon: <Settings size={40} /> },
  { key: "summary", title: "Ú†Ú©ÛŒØ¯Ù‡ Ø§Ø·Ù„Ø§Ø¹Ø§Øª", to: "/new-project/summary", image: SHIL_ASSETS.icons.project.summary, icon: <FileCheck size={40} /> },
  { key: "run", title: "Ø§Ø¬Ø±Ø§ÛŒ Ù…Ø­Ø§Ø³Ø¨Ø§Øª", to: "/new-project/run", image: SHIL_ASSETS.icons.project.run, icon: <Gauge size={40} /> },
  { key: "future", title: "ØªÙˆØ³Ø¹Ù‡", to: "/new-project/future", image: SHIL_ASSETS.icons.project.future, icon: <Cuboid size={40} /> },
];
