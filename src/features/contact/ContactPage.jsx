...
function ShilProductsHero({ onBack, onDashboard }) {
  return (
    ...
    >
      <div className="contact-products-hero__topbar v15-contact-topbar">
        <button className="btn btn--secondary" type="button" onClick={onDashboard}>داشبورد</button>
        <img src={PUBLIC_ASSETS.branding.appLogo} alt="SHIL IRAN" />
        <button className="btn btn--ghost" type="button" onClick={onBack}>بازگشت</button>
      </div>
