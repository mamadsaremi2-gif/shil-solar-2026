...
export function DashboardStats({ projectCount, systemStatus, isAdmin }) {
  ...
  return (
    <section className="shil-dashboard__stats" aria-label="خلاصه وضعیت">
      ...
      <article
        className={`shil-dashboard__stat shil-dashboard__stat--system is-${systemStatus.tone}`}
      >
        <span className="shil-dashboard__stat-icon" aria-hidden="true">
          ●
        </span>
