...
const SHIL_REMAINING_10_RULES = [
  {
    id: 1,
    name: "DC_Voltage_Level_Selection",
    place_in_engine: "voltage_level_selection",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
  ...
  {
    id: 2,
    name: "Breaker_Type_Selection",
    place_in_engine: "protection_DC_PV, protection_DC_BAT, protection_AC",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
      if_current_lte_63A: "MCB",
      if_current_gt_63A: "MCCB",
      if_DC_circuit: "DC Breaker or DC Isolator",
      if_AC_circuit: "MCB/MCCB + RCD",
    },
  },
  {
    id: 3,
    name: "Pole_Count_Selection",
    place_in_engine: "protection_DC_PV, protection_AC, panelboard_selection",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
      PV_DC: "2P or 4P",
  ...
  {
    id: 4,
    name: "Panelboard_Size_Selection",
    place_in_engine: "panelboard_selection",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
  ...
  {
    id: 5,
    name: "Panelboard_IP_Selection",
    place_in_engine: "environment_rules",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
      indoor: "IP40",
  ...
  {
    id: 6,
    name: "Cable_Voltage_Drop_Rule",
    place_in_engine: "cable_selection",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
      PV_DC: "1.5% - 3%",
  ...
  {
    id: 7,
    name: "SPD_Type_Selection",
    place_in_engine: "protection_DC_PV, protection_AC",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
      roof: "Type I+II",
  ...
  {
    id: 8,
    name: "Battery_Fuse_Type_Selection",
    place_in_engine: "protection_DC_BAT",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
  ...
  {
    id: 9,
    name: "Multi_MPPT_Management",
    place_in_engine: "mppt_validation",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
  ...
  {
    id: 10,
    name: "Panel_Layout_Space_Constraint",
    place_in_engine: "panel_string_design",
    null_safe: true,
    if_input_missing: "skip_rule",
    logic: {
