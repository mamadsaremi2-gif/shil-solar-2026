    ...
    <ShilPageShell title="کارتابل ادمین SHIL">
      ...
      {adminView === "hub" ? (
        <div className="shil-admin-module-hub-v10" aria-label="بخش‌های کارتابل ادمین">
          <section className="shil-default-entry-v254 shil-default-entry-v2541" aria-label="پیش‌فرض‌های مسیر پروژه">
            <button type="button" onClick={() => openDefaultsPath("solar")}><strong>خورشیدی</strong><span>پیش‌فرض‌های مسیر</span></button>
            <button type="button" onClick={() => openDefaultsPath("emergency")}><strong>برق اضطراری</strong><span>پیش‌فرض‌های مسیر</span></button>
          </section>
          ...
          {!defaultsPath ? (
            ...
            <>
              ...
              <div className="shil-default-actions-v254">
                <button type="button" onClick={()=>saveDefaultsData()}>ذخیره</button>
                <button type="button" className="primary" onClick={()=>publishDefaultsPath(defaultsPath)}>انتشار</button>
                <button type="button" onClick={()=>resetDefaultsPath(defaultsPath)}>بازنشانی</button>
              </div>
            </>
          )}
        </section>
