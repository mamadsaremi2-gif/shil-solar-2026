...
export default function SystemSettings() {
  ...
  const registeredCalculationParameters = useMemo(() => readDraft("shil:registeredCalculationParameters", {}), []);
  const load = useMemo(() => {
    const rawLoad = readDraft("shil:loadEngineResult", {});
    return {
      ...rawLoad,
      method: registeredCalculationParameters.method || rawLoad.method,
      methodTitle: registeredCalculationParameters.methodTitle || rawLoad.methodTitle,
      totalPowerW: registeredCalculationParameters.totalPowerW || rawLoad.totalPowerW || rawLoad?.load?.totalPowerW || 0,
      totalEnergyKWh: registeredCalculationParameters.totalEnergyKWh || rawLoad.totalEnergyKWh || rawLoad?.load?.totalEnergyKWh || 0,
      voltageAC: registeredCalculationParameters.voltageAC || rawLoad.voltageAC || rawLoad?.load?.voltageAC || 230,
      acCurrentA: registeredCalculationParameters.acCurrentA || rawLoad.acCurrentA || 0,
      startCurrentA: registeredCalculationParameters.startCurrentA || rawLoad.startCurrentA || 0,
      surgePowerW: registeredCalculationParameters.surgePowerW || rawLoad.surgePowerW || 0,
      motorCount: registeredCalculationParameters.motorCount || rawLoad.motorCount || 0,
      softStarterCount: registeredCalculationParameters.softStarterCount || rawLoad.softStarterCount || 0,
    };
  }, [registeredCalculationParameters]);
