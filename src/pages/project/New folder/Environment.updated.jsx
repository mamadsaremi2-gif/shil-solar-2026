  ...
  return (
    ...
    >
      ...
      <div className="shil-env-page">
        ...
        <section className="shil-env-card shil-env-summary-card">
          <h3 className="shil-section-title">چکیده شرایط محیطی</h3>
          <div className="shil-climate-grid">
            <div className="shil-climate-box">
              <span>شهر نصب</span>
              <strong>{selectedCity?.name || city || "-"}</strong>
            </div>
            <div className="shil-climate-box">
              <span>مختصات GPS</span>
              <strong>{latitude || "-"} ، {longitude || "-"}</strong>
            </div>
            <div className="shil-climate-box">
              <span>جهت نصب</span>
              <strong>
                {directionOptions.find((item) => item.deg === assessment.selectedAzimuthDeg)?.label || `${assessment.selectedAzimuthDeg}°`}
              </strong>
            </div>
            <div className="shil-climate-box">
              <span>زاویه پنل</span>
              <strong>{assessment.selectedTiltDeg}°</strong>
            </div>
            <div className="shil-climate-box">
              <span>شرایط نصب محیطی</span>
              <strong>{activeInstallType.label || "-"}</strong>
            </div>
            <div className="shil-climate-box">
              <span>درجه حفاظت</span>
              <strong>{assessment.recommendedIngressProtection || "-"}</strong>
            </div>
            <div className="shil-climate-box">
              <span>راندمان نهایی</span>
