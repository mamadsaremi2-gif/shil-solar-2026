    ...
    <EngineeringPageShell title="انتخاب مسیر پروژه">
      <section className="shil-card-stack">
        <div className="shil-section-card">
          ...
          {selectedOption ? (
            <div className="shil-section-card shil-project-path-summary" role="status" aria-live="polite">
              <div className="shil-section-head">
                <h2>چکیده انتخاب مسیر پروژه</h2>
                <span>Project Path Summary</span>
              </div>
              <div className="shil-summary-row">
                <span>مسیر انتخاب‌شده</span>
                <strong>{selectedOption.title}</strong>
              </div>
              {selectedOption.description ? (
                <p className="shil-summary-note">{selectedOption.description}</p>
              ) : null}
            </div>
          ) : null}
