      ...
      <section className="shil-card-stack">
        <div className="shil-section-card">
          ...
          <div className="shil-form-grid">
            <label><span>نام پروژه</span><input defaultValue="X" placeholder="مثلاً پروژه ویلایی شمال" data-required="true" /></label>
            <label><span>نام کارفرما</span><input defaultValue="SHIL CO" placeholder="نام شخص یا شرکت" /></label>
