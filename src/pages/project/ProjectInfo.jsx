      ...
      <section className="shil-card-stack">
        <div className="shil-section-card">
          ...
          <div className="shil-form-grid">
            <label><span>نام پروژه</span><input placeholder="مثلاً پروژه ویلایی شمال" /></label>
            <label><span>نام کارفرما</span><input placeholder="نام شخص یا شرکت" /></label>
            <label><span>نوع کاربری</span><select><option>خانگی</option><option>اداری</option><option>تجاری</option><option>صنعتی</option><option>کشاورزی</option></select></label>
