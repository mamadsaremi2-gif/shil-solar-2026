...
export default function SystemSettings() {
  ...
  const confirmSolar = () => {
    if (!solarDesign.valid) {
      setWarning(solarDesign.nextBlockedReason || "Ù¾ÛŒÚ©Ø±Ø¨Ù†Ø¯ÛŒ Ø¨Ø§ ØªÙˆØ§Ù† Ù…ØµØ±ÙÛŒ Ù‡Ù…Ø®ÙˆØ§Ù†ÛŒ Ù†Ø¯Ø§Ø±Ø¯Ø› Ø¹Ù„Øª Ø®Ø·Ø§ Ø±Ø§ Ø§ØµÙ„Ø§Ø­ Ú©Ù†ÛŒØ¯.");
      return;
    }
  ...
  return (
    <EngineeringPageShell title="Ù¾ÛŒÚ©Ø±Ø¨Ù†Ø¯ÛŒ ØªØ¬Ù‡ÛŒØ²Ø§Øª Ø³ÛŒØ³ØªÙ…">
      <section className="shil-card-stack shil-solar-config-page shil-system-final-page">
        ...
        <div className="shil-section-card shil-config-block">
          <div className="shil-section-head"><h2>Ù¾Ø§Ø±Ø§Ù…ØªØ±Ù‡Ø§ÛŒ Ø§Ø«Ø±Ú¯Ø°Ø§Ø±</h2><span>Ù…Ø³ØªÙ‚ÛŒÙ… Ø¯Ø± Ø§Ù†ØªØ®Ø§Ø¨ ØªØ¬Ù‡ÛŒØ²Ø§Øª</span></div>
        ...
        <button type="button" className="shil-primary-wide shil-confirm-config-button" onClick={confirmSolar}>ØªØ£ÛŒÛŒØ¯ Ù¾ÛŒÚ©Ø±Ø¨Ù†Ø¯ÛŒ Ùˆ Ø±ÙØªÙ† Ø¨Ù‡ Ú†Ú©ÛŒØ¯Ù‡</button>
      </section>
    </EngineeringPageShell>
  );
}
