 ...
 */
export default function ShilWarningOverlay({ messages = [], children = null, inline = false }) {
  ...
  const content = (
    <div className={inline ? "shil-warning-overlay shil-warning-overlay--inline" : "shil-warning-overlay"} role="status" aria-live="polite">
