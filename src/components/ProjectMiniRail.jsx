...
function getActiveStepKey(pathname) {
  ...
  if (pathname.startsWith("/new-project/path") || pathname.startsWith("/new-project/solar/select")) return "path";
  if (pathname.startsWith("/new-project/method") || pathname.startsWith("/new-project/solar/") || pathname.startsWith("/new-project/emergency")) return "method";
  if (pathname.startsWith("/new-project/input") || pathname.startsWith("/new-project/inputs")) return "inputs";
  if (pathname.startsWith("/new-project/execution") || pathname.startsWith("/new-project/system")) return "system";
