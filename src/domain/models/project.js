export const SYSTEM_GROUPS = [
  ...
  { value: "backup", label: "سیستم بدون پنل خورشیدی (برق اضطراری)", description: "طراحی تامین برق اضطراری با باتری؛ سانورتر و بانک باتری بدون ورود اطلاعات پنل" },
];
...
export const SYSTEM_TYPES = [
  ...
  { value: "backup", group: "backup", label: "تامین برق اضطراری با باتری", description: "سیستم بدون پنل برای تامین برق اضطراری بار با سانورتر و باطری" },
];
...
export const BATTERY_UNIT_VOLTAGE_OPTIONS = [12, 12.6, 12.8, 24, 25, 25.6, 26, 48, 51, 51.2, 52];
...
export const DEFAULT_PROJECT_FORM = {
  ...
  longitude: 51.67,
  gpsAccuracyM: 0,
  compassAzimuthDeg: 180,
  azimuthDeg: 0,
  sitePhotoUrl: "",
  compassScreenshotUrl: "",
  shadowObstacleHeightM: "",
  shadowObstacleDistanceM: "",
  shadowObstacleDirectionDeg: 180,
  shadowCriticalHours: "",
  climateDataSource: "offline_iran_climate_cache",
  climateCorrectionEnabled: false,
  shadingFactor: 0.95,
  dustFactor: 0.96,
  tiltAngle: 30,
  systemVoltage: 48,
  ...
  controllerType: "MPPT",
  controllerMaxVoc: 500,
  maxPvVocV: 500,
  mpptMinVoltage: 30,
  mpptMaxVoltage: 450,
  mpptStartupVoltage: 30,
  mpptCount: 1,
  maxPvPowerPerMpptW: 0,
  maxPvPowerW: 0,
